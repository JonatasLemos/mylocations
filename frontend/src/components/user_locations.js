            ...
            <React.Fragment key={location.user_location_id}>
              <tr>
                ...
                <td className="text-center">
                  <button
                    className={`btn btn-${expanded[location.user_location_id] ? 'danger' : 'primary'} btn-sm`}
                    onClick={() => toggleDetails(location.user_location_id)}
                  >
                    {expanded[location.user_location_id] ? 'Hide Details' : 'Show Details'}
                  </button>
                </td>
              </tr>
                ...
                <tr>
                  <td colSpan="3">
                    <div className="card p-3">
                      ...
                      <p><strong>Location Type:</strong> {location.location_type_name}</p>
                    </div>
                  </td>
                </tr>
              )}
